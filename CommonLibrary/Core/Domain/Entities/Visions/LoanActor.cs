...
{
    [Table("Actor", Schema = "Vision")]
    public class LoanActor
    {
        public LoanActor()
        {
            this.ActorActionFlows = new HashSet<ActorActionFlow>();
            this.ReferenceHistories = new HashSet<ReferenceHistory>();
        }
        [Key]
        ...
        public ICollection<ActorActionFlow> ActorActionFlows { get; set; }
