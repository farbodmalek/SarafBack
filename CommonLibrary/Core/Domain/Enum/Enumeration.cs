   ...
   public class Enumeration
    {
        ...
        public static T FromDisplayName<T>(string displayName) where T : Enumeration
        {
            ...
            if (matchingItem == null) return (T)(new Enumeration(100, "نامشخص"));
            return matchingItem;
        }
        //public static int GetKey(Enumeration private enum)
        //{
        //    return enum.Id;
        //}
        protected static T Parse<T, K>(K value, string description, Func<T,
